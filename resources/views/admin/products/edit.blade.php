...
<div class="form-group">
    ...
    <div class="col-sm-10">
        {!! Form::text('order_by', old('order_by',$products->order_by), array('class'=>'form-control')) !!}
        
    </div>
</div><div class="form-group">
    {!! Form::label('status', 'Status', array('class'=>'col-sm-2 control-label')) !!}
    <div class="col-sm-10">
        {!! Form::select('status', $status, old('status',$products->status), array('class'=>'form-control')) !!}
