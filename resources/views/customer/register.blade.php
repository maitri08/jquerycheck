...
@endif
  ...
  <p>Name</p>
      ...
      @if ($errors->has('contact')) <span class="help-block">{{ $errors->first('contact') }}</span> @endif
        ...
        <p>Password</p>
      <div class="form-group has-feedback">
        {{ Form::password('password','',['id'=> 'password','class'=> 'form_text','autofocus'=> ($errors->has('password') ? 'autofocus' : null)])}}
        @if ($errors->has('password')) <span class="help-block">{{ $errors->first('password') }}</span> @endif
        <span class="glyphicon glyphicon-lock form-control-feedback"></span>
      </div>
        <p>Confirm Password</p>
        <div class="form-group has-feedback">
        {{ Form::password('password_confirm','',['id'=> 'password_confirm','class'=> 'form_text','autofocus'=> ($errors->has('password_confirm') ? 'autofocus' : null)])}}
